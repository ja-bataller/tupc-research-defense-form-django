...
class SignUpForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'username': forms.TextInput(attrs={'class': 'form-control mb-3',  'autocomplete': 'off', 'name': 'usernameForm', 'required': 'on', 'placeholder': 'TUPC-XX-XXXX', 'onkeyup': "this.value = this.value.toUpperCase();"}),
