...
def  libraryDashboard(request):
    ...
    get_pending_receipt = AcknowledgementReceipt.objects.all().filter(library_response ="pending")
...
def  libraryLogs(request):
    ...
    get_accepted_receipt = AcknowledgementReceipt.objects.all().filter(library_response ="Accepted")
...
def  libraryCreateESignature(request):
    ...
    return render(request, "library-signature-pad.html", context)
...
def  libraryAcceptSignature(request, id):
    ...
    try:
        ...
        check_receipt.library_username = currently_loggedin_user.username
        check_receipt.library_full_name = currently_loggedin_user_full_name
        check_receipt.library_response = "Accepted"
        check_receipt.library_response_date = date_today
        check_receipt.library_signature = True
