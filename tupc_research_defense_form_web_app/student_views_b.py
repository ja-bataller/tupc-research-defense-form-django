...
def studentDownloadPanelInvitationBet3(request, id):
    ...
    # Deployed - Syntax
    doc = Document('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/forms/1-TOPIC-DEFENSE-PANEL-INVITATION.docx')
    ...
    if panel_response == "accepted":
        ...
        panel_table.cell(0, 3).paragraphs[0].runs[0].text = "_"

    if panel_response == "declined":
        panel_table.cell(0, 1).paragraphs[0].runs[0].text = "_"
        panel_table.cell(0, 3).paragraphs[0].runs[0].text = "✓"


    if get_panel_invitation.dit_head_signature == 1:
        # Check if DIT Head E-Sign Exist
        # if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django//home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_panel_invitation.dit_head_username) + ".png"):
        if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_panel_invitation.dit_head_username) + ".png"):
            dit_sign_box.cell(0, 0).text = ''
            head_signature = dit_sign_box.cell(0, 0).add_paragraph()
            head_signature_run = head_signature.add_run()
            head_signature_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_panel_invitation.dit_head_username +'.png',width=Inches(1.2), height=Inches(0.45))
        else:
            get_panel_invitations = TitlePanelInvitation.objects.all().filter(student_leader_username=current_user.username)
            get_accepted_panel_invitations = TitlePanelInvitation.objects.all().filter(student_leader_username=current_user.username, form_status="accepted")
            get_pending_panel_invitations = TitlePanelInvitation.objects.all().filter(student_leader_username=current_user.username, form_status="pending")
    ...
    if get_panel_invitation.panel_signature == True:
        ...
        if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_panel_invitation.panel_username) + ".png"):
            ...
            panel_signature_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_panel_invitation.panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
    ...
    # Deployed - Syntax
    doc.save('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +"-"+panel_username+"-"+panel_response+'-TOPIC-DEFENSE-PANEL-INVITATION.docx')
    subprocess.call(['libreoffice', '--headless', '--convert-to', 'pdf', "/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"+current_user.username+"-"+panel_username+"-"+panel_response+'-TOPIC-DEFENSE-PANEL-INVITATION.docx', "--outdir" ,"/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"])
    download_link = "http://unofficialtupcresearchdefense.pythonanywhere.com/static/" +current_user.username +"-"+panel_username+"-"+panel_response+'-TOPIC-DEFENSE-PANEL-INVITATION.pdf'

    filePath =  FilePath(
        student_leader_username = current_user.username,
        file_path = '/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +"-"+panel_username+"-"+panel_response+'-TOPIC-DEFENSE-PANEL-INVITATION.pdf'
    )
    filePath.save()
    ...
    # Deployed - Syntax
    bet3_topic_defense_panel_inviation_docx = ("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"+current_user.username+"-"+panel_username+"-"+panel_response+'-TOPIC-DEFENSE-PANEL-INVITATION.docx')
...
def studentDownloadBET3ResearchTitleDefenseForm(request):
    ...
    # Deployed - Syntax
    doc = Document('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/forms/2-RESEARCH-TITLE-DEFENSE-FORM.docx')
    ...
    doc.paragraphs[6].runs[0].text = panel_chairman
    ...
    if get_panel_chairman.panel_signature_attach == True:
        # Check if Panel E-Sign Exist
        if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_panel_chairman.panel_username) + ".png"):
            panel_chair_signature_table.cell(0, 0).text = ''
            panel_signature = panel_chair_signature_table.cell(0, 0).add_paragraph()
            panel_signature_run = panel_signature.add_run()
            panel_signature_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_panel_chairman.panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
    ...
    try:
        ...
        if get_panel_members[0].panel_signature_attach == True:
            print("pass")
            # Check if Panel E-Sign Exist
            if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_panel_members[0].panel_username) + ".png"):
                panel1_sign_box.cell(0, 0).text = ''
                panel_signature = panel1_sign_box.cell(0, 0).add_paragraph()
                panel_signature_run = panel_signature.add_run()
                panel_signature_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_panel_members[0].panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
    ...
    try:
        ...
        if get_panel_members[1].panel_signature_attach == True:
            print("pass")
            # Check if Panel E-Sign Exist
            if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_panel_members[1].panel_username) + ".png"):
                panel2_sign_box.cell(0, 0).text = ''
                panel_signature = panel2_sign_box.cell(0, 0).add_paragraph()
                panel_signature_run = panel_signature.add_run()
                panel_signature_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_panel_members[1].panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
            else:
                context = {
                    "response": "sweet faculty member no signature",
                }
    ...
    try:
        ...
        if get_panel_members[2].panel_signature_attach == True:
            print("pass")
            # Check if Panel E-Sign Exist
            if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_panel_members[2].panel_username) + ".png"):
                panel3_sign_box.cell(0, 0).text = ''
                panel_signature = panel3_sign_box.cell(0, 0).add_paragraph()
                panel_signature_run = panel_signature.add_run()
                panel_signature_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_panel_members[2].panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
            else:
                context = {
                    "response": "sweet faculty member no signature",
                }
    ...
    try:
        ...
        if get_panel_members[3].panel_signature_attach == True:
            print("pass")
            # Check if Panel E-Sign Exist
            if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_panel_members[3].panel_username) + ".png"):
                panel4_sign_box.cell(0, 0).text = ''
                panel_signature = panel4_sign_box.cell(0, 0).add_paragraph()
                panel_signature_run = panel_signature.add_run()
                panel_signature_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_panel_members[3].panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
            else:
                context = {
                    "response": "sweet faculty member no signature",
                }
    ...
    # Deployed - Syntax
    doc.save('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username + '-BET3-RESEARCH-TITLE-DEFENSE-FORM.docx')
    subprocess.call(['libreoffice', '--headless', '--convert-to', 'pdf', "/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"+current_user.username + '-BET3-RESEARCH-TITLE-DEFENSE-FORM.docx', "--outdir" ,"/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"])
    download_link = "http://unofficialtupcresearchdefense.pythonanywhere.com/static/"+current_user.username + '-BET3-RESEARCH-TITLE-DEFENSE-FORM.pdf'

    filePath =  FilePath(
        student_leader_username = current_user.username,
        file_path = '/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username + '-BET3-RESEARCH-TITLE-DEFENSE-FORM.pdf'
    )
    filePath.save()
    ...
    # Deployed - Syntax
    bet3_research_title_defense_form_docx = ("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/" + current_user.username + '-BET3-RESEARCH-TITLE-DEFENSE-FORM.docx')
...
def studentTopicPanelConformeDownload(request, id):
    ...
    # Deployed - Syntax
    doc = Document('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/forms/TOPIC-PANEL-CONFORME.docx')
    ...
    if get_panel_conforme.dit_head_signature == 1:
        # Check if DIT Head E-Sign Exist
        if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_panel_conforme.dit_head_username) + ".png"):
            dit_head_signature_box.cell(0, 0).text = ''
            head_signature = dit_head_signature_box.cell(0, 0).add_paragraph()
            head_signature_run = head_signature.add_run()
            head_signature_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_panel_conforme.dit_head_username +'.png',width=Inches(1.2), height=Inches(0.45))
        else:
            get_all_topic_panel_conforme = PanelConforme.objects.all().filter(student_leader_username=current_user.username, form = "Topic Panel Conforme")
            get_all_pending_topic_panel_conforme = PanelConforme.objects.all().filter(student_leader_username=current_user.username, form = "Topic Panel Conforme", is_completed = False)
    ...
    if get_panel_conforme.panel_signature == True:
        # Check if Panel E-Sign Exist
        if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_panel_conforme.panel_username) + ".png"):
            panel_signature_box.cell(0, 0).text = ''
            panel_signature = panel_signature_box.cell(0, 0).add_paragraph()
            panel_signature_run = panel_signature.add_run()
            panel_signature_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_panel_conforme.panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
    ...
    # Deployed - Syntax
    doc.save('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +"-"+panel_username+"-"+panel_response+'-TOPIC-PANEL-CONFORME.docx')
    subprocess.call(['libreoffice', '--headless', '--convert-to', 'pdf', "/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"+current_user.username+"-"+panel_username+"-"+panel_response+'-TOPIC-PANEL-CONFORME.docx', "--outdir" ,"/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"])
    download_link = "http://unofficialtupcresearchdefense.pythonanywhere.com/static/" +current_user.username +"-"+panel_username+"-"+panel_response+'-TOPIC-PANEL-CONFORME.pdf'

    filePath =  FilePath(
        student_leader_username = current_user.username,
        file_path = '/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +"-"+panel_username+"-"+panel_response+'-TOPIC-PANEL-CONFORME.pdf'
    )
    filePath.save()
    ...
    # Deployed - Syntax
    bet3_topic_defense_panel_inviation_docx = ("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/" + current_user.username +"-"+panel_username+"-"+panel_response+'-TOPIC-PANEL-CONFORME.docx')
...
def studentProposalPanelConformeDownload(request, id):
    ...
    # Deployed - Syntax
    doc = Document('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/forms/PROPOSAL-PANEL-CONFORME.docx')
    ...
    # Deployed - Syntax
    doc.save('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +"-"+panel_username+"-"+panel_response+'-PROPOSAL-PANEL-CONFORME.docx')
    subprocess.call(['libreoffice', '--headless', '--convert-to', 'pdf', "/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"+current_user.username+"-"+panel_username+"-"+panel_response+'-PROPOSAL-PANEL-CONFORME.docx', "--outdir" ,"/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"])
    download_link = "http://unofficialtupcresearchdefense.pythonanywhere.com/static/" +current_user.username +"-"+panel_username+"-"+panel_response+'-PROPOSAL-PANEL-CONFORME.pdf'

    filePath =  FilePath(
        student_leader_username = current_user.username,
        file_path = '/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +"-"+panel_username+"-"+panel_response+'-PROPOSAL-PANEL-CONFORME.pdf'
    )
    filePath.save()
    ...
    bet3_topic_defense_panel_inviation_docx = ("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/" + current_user.username +"-"+panel_username+"-"+panel_response+'-PROPOSAL-PANEL-CONFORME.docx')
...
def studentFinalPanelConformeDownload(request, id):
    ...
    doc = Document('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/forms/FINAL-PANEL-CONFORME.docx')
    ...
    doc.save('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +"-"+panel_username+"-"+panel_response+'-FINAL-PANEL-CONFORME.docx')
    subprocess.call(['libreoffice', '--headless', '--convert-to', 'pdf', "/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"+current_user.username+"-"+panel_username+"-"+panel_response+'-FINAL-PANEL-CONFORME.docx', "--outdir" ,"/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"])
    download_link = "http://unofficialtupcresearchdefense.pythonanywhere.com/static/" +current_user.username +"-"+panel_username+"-"+panel_response+'-FINAL-PANEL-CONFORME.pdf'

    filePath =  FilePath(
        student_leader_username = current_user.username,
        file_path = '/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +"-"+panel_username+"-"+panel_response+'-FINAL-PANEL-CONFORME.pdf'
    )
    filePath.save()
...
def studentBET3AdviserDashboard(request):
    ...
    if request.method == "POST":
        ...
        try:
            get_dit_head_data = User.objects.get(is_department_head = True)
...
def studentBET3AdviserConformeDownload(request):
    ...
    doc = Document('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/forms/3-RESEARCH-ADVISER-CONFORME.docx')
    ...
    doc.paragraphs[32].runs[0].text = adviser_response_date

    head_signature_table = doc.tables[2]
    adviser_signature_table = doc.tables[4]

    if get_adviser_conforme.dit_head_signature == 1:
        # Check if DIT Head E-Sign Exist
        if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_adviser_conforme.dit_head_username) + ".png"):
            head_signature_table.cell(0, 0).text = ''
            head_signature = head_signature_table.cell(0, 0).add_paragraph()
            head_signature_run = head_signature.add_run()
            head_signature_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_adviser_conforme.dit_head_username +'.png',width=Inches(1.2), height=Inches(0.45))
        else:
            get_advisers = User.objects.all().filter(is_adviser=1)
    ...
    if get_adviser_conforme.adviser_signature == 1:
        ...
        # Check if DIT Head E-Sign Exist
        if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_adviser_conforme.adviser_username) + ".png"):
            ...
            adviser_signature_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_adviser_conforme.adviser_username +'.png',width=Inches(1.2), height=Inches(0.45))
        else:
            print("Not Found")
            get_advisers = User.objects.all().filter(is_adviser=1)
    ...
    doc.save('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +'-BET3-ADVISER-CONFORME.docx')
    subprocess.call(['libreoffice', '--headless', '--convert-to', 'pdf', "/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"+current_user.username +'-BET3-ADVISER-CONFORME.docx', "--outdir" ,"/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"])
    download_link = "http://unofficialtupcresearchdefense.pythonanywhere.com/static/"+current_user.username +'-BET3-ADVISER-CONFORME.pdf'

    filePath =  FilePath(
        student_leader_username = current_user.username,
        file_path = '/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +'-BET3-ADVISER-CONFORME.pdf'
    )
    filePath.save()
    # UN COMMENT IF DEPLOYED
    ...
    bet3_adviser_conforme_docx = ("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/" + current_user.username +'-BET3-ADVISER-CONFORME.docx')
...
def studentBET3ProposalDefensePanelInvitationDownload(request, id):
    ...
    doc = Document('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/forms/4-PROPOSAL-DEFENSE-PANEL-INVITATION.docx')
    ...
    if get_panel_invitation.panel_signature == True:
        ...
        if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_panel_invitation.panel_username) + ".png"):
            panel_signature_box.cell(0, 0).text = ''
            panel_signature = panel_signature_box.cell(0, 0).paragraphs[0]
            panel_signature_run = panel_signature.add_run()
            panel_signature_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_panel_invitation.panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
    ...
    doc.save('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +"-"+panel_username+"-"+panel_response+'BET3-PROPOSAL-DEFENSE-PANEL-INVITATION.docx')
    subprocess.call(['libreoffice', '--headless', '--convert-to', 'pdf', "/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"+current_user.username+"-"+panel_username+"-"+panel_response+'BET3-PROPOSAL-DEFENSE-PANEL-INVITATION.docx', "--outdir" ,"/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"])
    download_link = "http://unofficialtupcresearchdefense.pythonanywhere.com/static/" +current_user.username +"-"+panel_username+"-"+panel_response+'BET3-PROPOSAL-DEFENSE-PANEL-INVITATION.pdf'

    filePath =  FilePath(
        student_leader_username = current_user.username,
        file_path = '/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +"-"+panel_username+"-"+panel_response+'BET3-PROPOSAL-DEFENSE-PANEL-INVITATION.pdf'
    )
    filePath.save()
    ...
    bet3_proposal_defense_panel_inviation_docx = ("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/" + current_user.username +"-"+panel_username+"-"+panel_response+'-BET3-PROPOSAL-DEFENSE-PANEL-INVITATION.docx')
...
def studentBET3CritiqueFormDownload(request):
    ...
    doc = Document('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/forms/5-CRITIQUE-FORM.docx')
    ...
    if get_critique_form_panel_chair_data[0]:
        ...
        if get_critique_form_panel_chair_data[0].panel_chairman_signature_attach == True:
            if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_critique_form_panel_chair_data[0].panel_username) + ".png"):
                ...
                panel_chair_sign_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_critique_form_panel_chair_data[0].panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
                # panel_chair_sign_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_critique_form_panel_chair_data[0].panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
            else:
                context = {
                    "currently_loggedin_user_full_name": currently_loggedin_user_full_name,
    ...
    if get_critique_form_panel_data[0]:
        ...
        if get_critique_form_panel_data[0].panel_signature_attach == True:
            if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_critique_form_panel_data[0].panel_username) + ".png"):
                panel_table_1.cell(0, 0).text = ""
                panel_sign = panel_1.cell(0, 0).add_paragraph()
                panel_sign_run = panel_sign.add_run()
                panel_sign_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_critique_form_panel_data[0].panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
                # panel_chair_sign_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_critique_form_panel_chair_data[0].panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
            else:
                context = {
                    "currently_loggedin_user_full_name": currently_loggedin_user_full_name,
    ...
    if get_critique_form_panel_data[1]:
        ...
        if get_critique_form_panel_data[1].panel_signature_attach == True:
            if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_critique_form_panel_data[1].panel_username) + ".png"):
                panel_table_1.cell(0, 4).text = ""
                panel_sign = panel_3.cell(0, 0).add_paragraph()
                panel_sign_run = panel_sign.add_run()
                panel_sign_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_critique_form_panel_data[1].panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
                # panel_chair_sign_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_critique_form_panel_chair_data[0].panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
            else:
                context = {
                    "currently_loggedin_user_full_name": currently_loggedin_user_full_name,
    ...
    if get_critique_form_panel_data[2]:
        ...
        if get_critique_form_panel_data[2].panel_signature_attach == True:
            if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_critique_form_panel_data[2].panel_username) + ".png"):
                panel_table_2.cell(0, 0).text = ""
                panel_sign = panel_4.cell(0, 0).add_paragraph()
                panel_sign_run = panel_sign.add_run()
                panel_sign_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_critique_form_panel_data[2].panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
                # panel_chair_sign_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_critique_form_panel_chair_data[0].panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
            else:
                context = {
                    "currently_loggedin_user_full_name": currently_loggedin_user_full_name,
    ...
    try:
        ...
        if get_critique_form_panel_data[3]:
            ...
            if get_critique_form_panel_data[1].panel_signature_attach == True:
                if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_critique_form_panel_data[3].panel_username) + ".png"):
                    panel_table_2.cell(0, 4).text = ""
                    panel_sign = panel_5.cell(0, 0).add_paragraph()
                    panel_sign_run = panel_sign.add_run()
                    panel_sign_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_critique_form_panel_data[3].panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
                    # panel_chair_sign_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_critique_form_panel_chair_data[0].panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
                else:
                    context = {
                        "currently_loggedin_user_full_name": currently_loggedin_user_full_name,
    ...
    doc.save('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username + "-BET3-CRITIQUE-FORM.docx")
    subprocess.call(['libreoffice', '--headless', '--convert-to', 'pdf', "/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"+current_user.username + "-BET3-CRITIQUE-FORM.docx", "--outdir" ,"/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"])
    download_link = "http://unofficialtupcresearchdefense.pythonanywhere.com/static/"+current_user.username+'-BET3-CRITIQUE-FORM.pdf'

    filePath =  FilePath(
        student_leader_username = current_user.username,
        file_path = '/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +'-BET3-CRITIQUE-FORM.pdf'
    )
    filePath.save()
    ...
    delete_critique_form = ("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"+current_user.username+'-BET3-CRITIQUE-FORM.docx')
...
def studentBET3ResearchProposalDefenseFormDownload(request):
    ...
    doc = Document('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/forms/6-RESEARCH-PROPOSAL-DEFENSE-FORM.docx')
    ...
    if get_proposal_defense_form[0]:
        ...
        if get_proposal_defense_form[0].panel_signature_attach == True:
            if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_proposal_defense_form[0].panel_username) + ".png"):
                if get_proposal_defense_form[0].proposal_defense_response == "Accepted with Revision":
                    ...
                    panel_sign_run = panel_sign.add_run()
                    panel_sign_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_proposal_defense_form[0].panel_username +'.png',width=Inches(0.708661), height=Inches(0.23622))
    ...
    if get_proposal_defense_form[1]:
        ...
        if get_proposal_defense_form[1].panel_signature_attach == True:
            if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_proposal_defense_form[1].panel_username) + ".png"):
                if get_proposal_defense_form[1].proposal_defense_response == "Accepted with Revision":
                    ...
                    panel_sign.alignment = WD_ALIGN_PARAGRAPH.CENTER
                    panel_sign_run = panel_sign.add_run()
                    panel_sign_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_proposal_defense_form[1].panel_username +'.png',width=Inches(0.708661), height=Inches(0.23622))
    ...
    if get_proposal_defense_form[2]:
        ...
        if get_proposal_defense_form[2].panel_signature_attach == True:
            if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_proposal_defense_form[2].panel_username) + ".png"):
                if get_proposal_defense_form[2].proposal_defense_response == "Accepted with Revision":
                    ...
                    panel_sign.alignment = WD_ALIGN_PARAGRAPH.CENTER
                    panel_sign_run = panel_sign.add_run()
                    panel_sign_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_proposal_defense_form[2].panel_username +'.png',width=Inches(0.708661), height=Inches(0.23622))
    ...
    if get_proposal_defense_form[3]:
        ...
        if get_proposal_defense_form[3].panel_signature_attach == True:
            if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_proposal_defense_form[3].panel_username) + ".png"):
                if get_proposal_defense_form[3].proposal_defense_response == "Accepted with Revision":
                    ...
                    panel_sign.alignment = WD_ALIGN_PARAGRAPH.CENTER
                    panel_sign_run = panel_sign.add_run()
                    panel_sign_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_proposal_defense_form[3].panel_username +'.png',width=Inches(0.708661), height=Inches(0.23622))
    ...
    try:
        if get_proposal_defense_form[4]:
            ...
            if get_proposal_defense_form[4].panel_signature_attach == True:
                if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_proposal_defense_form[4].panel_username) + ".png"):
                    if get_proposal_defense_form[4].proposal_defense_response == "Accepted with Revision":
                        ...
                        panel_sign.alignment = WD_ALIGN_PARAGRAPH.CENTER
                        panel_sign_run = panel_sign.add_run()
                        panel_sign_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_proposal_defense_form[4].panel_username +'.png',width=Inches(0.708661), height=Inches(0.23622))
    ...
    if get_panel_chair_proposal_defense_form[0]:
        ...
        if get_panel_chair_proposal_defense_form[0].panel_chairman_signature_attach == True:
            if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_panel_chair_proposal_defense_form[0].panel_username) + ".png"):
                panelchair_table.cell(0, 0).text = ""
                panel_sign = panelchair_table.cell(0, 0).add_paragraph()
                panel_sign.alignment = WD_ALIGN_PARAGRAPH.CENTER
                panel_sign_run = panel_sign.add_run()
                panel_sign_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_panel_chair_proposal_defense_form[0].panel_username +'.png',width=Inches(1.2), height=Inches(0.45))
    ...
    doc.save('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username + "-BET3-RESEARCH-PROPOSAL-DEFENSE-FORM.docx")
    subprocess.call(['libreoffice', '--headless', '--convert-to', 'pdf', "/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"+current_user.username + "-BET3-RESEARCH-PROPOSAL-DEFENSE-FORM.docx", "--outdir" ,"/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"])
    download_link = "http://unofficialtupcresearchdefense.pythonanywhere.com/static/" +current_user.username + "-BET3-RESEARCH-PROPOSAL-DEFENSE-FORM.pdf"

    filePath =  FilePath(
        student_leader_username = current_user.username,
        file_path = '/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username+'-BET3-RESEARCH-PROPOSAL-DEFENSE-FORM.pdf'
    )
    filePath.save()
    ...
    delete_critique_form = ("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"+current_user.username+'-BET3-RESEARCH-PROPOSAL-DEFENSE-FORM.docx')
...
def studentBET5FinalDefensePanelInvitationDownload(request, id):
    ...
    doc = Document('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/forms/7-FINAL-DEFENSE-PANEL-INVITATION.docx')
    ...
    doc.save('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +"-"+panel_username+"-"+panel_response+'-BET5-FINAL-DEFENSE-PANEL-INVITATION.docx')
    subprocess.call(['libreoffice', '--headless', '--convert-to', 'pdf', "/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"+current_user.username+"-"+panel_username+"-"+panel_response+'-BET5-FINAL-DEFENSE-PANEL-INVITATION.docx', "--outdir" ,"/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"])
    download_link = "http://unofficialtupcresearchdefense.pythonanywhere.com/static/" +current_user.username +"-"+panel_username+"-"+panel_response+'-BET5-FINAL-DEFENSE-PANEL-INVITATION.pdf'

    filePath =  FilePath(
        student_leader_username = current_user.username,
        file_path = '/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +"-"+panel_username+"-"+panel_response+'-BET5-FINAL-DEFENSE-PANEL-INVITATION.pdf'
    )
    filePath.save()
    ...
    bet3_proposal_defense_panel_inviation_docx = ("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/" + current_user.username +"-"+panel_username+"-"+panel_response+'-BET5-FINAL-DEFENSE-PANEL-INVITATION.docx')
...
def studentBET5ResearchFinalDefenseFormDownload(request):
    ...
    doc = Document('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/forms/8-RESEARCH-FINAL-DEFENSE-FORM.docx')
    ...
    doc.save('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +"-"+'BET5-RESEARCH-FINAL-DEFENSE-FORM.docx')
    subprocess.call(['libreoffice', '--headless', '--convert-to', 'pdf', "/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"+current_user.username+'-BET5-RESEARCH-FINAL-DEFENSE-FORM.docx', "--outdir" ,"/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"])
    download_link = "http://unofficialtupcresearchdefense.pythonanywhere.com/static/" +current_user.username+'-BET5-RESEARCH-FINAL-DEFENSE-FORM.pdf'

    filePath =  FilePath(
        student_leader_username = current_user.username,
        file_path = '/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/'+current_user.username +'-BET5-RESEARCH-FINAL-DEFENSE-FORM.pdf'
    )
    filePath.save()
    ...
    delete_critique_form = ("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/static/"+current_user.username +'-BET5-RESEARCH-FINAL-DEFENSE-FORM.docx')
...
def studentAcknowledgmentReceiptDownload(request):
    ...
    if get_receipt.research_ext_signature == True:
        # Check if Panel E-Sign Exist
        if os.path.exists("/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/" + str(get_receipt.research_ext_username) + ".png"):
            department_box.cell(4, 4).text = ''
            panel_signature = department_box.cell(4, 4).add_paragraph()
            panel_signature_run = panel_signature.add_run()
            panel_signature_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_receipt.research_ext_username +'.png',width=Inches(1.2), height=Inches(0.45))
            panel_signature_run.add_picture('/home/unofficialtupcresearchdefense/tupc-research-defense-form-django/uhsG1tCRrm3fUHcG4dyEMDDq31WQULMNJkSGQFq0oiV5vvhui9/'+get_receipt.research_ext_username +'.png',width=Inches(1.2), height=Inches(0.45))
        else:
            return redirect("student-dashboard")
